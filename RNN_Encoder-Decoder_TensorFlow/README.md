...
|---|---|---|---|
|total|0.991|20000|
|train data|0.997|18000 (90.0%)|
|test data|0.934|2000 (10.0%)|

<br>

### 学習済みモデルでのテスト用データでの応答処理結果
...
|---|---|---|---|---|---|---|---|---|---|---|
|質問 Q|1+773|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|
|応答 A|774|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|xxx|
|正誤|-|○|○|○|○|○|○|○|○|-|-|
