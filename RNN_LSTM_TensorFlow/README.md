...
- ｛隠れ層：**128** ノード、多層 RNN の層数: **1** ｝の LSTM
    ...
    - エポック回数 **40**, ミニバッチサイズ 100、イテレーション回数 10000


##### 損失関数のグラフ（実行条件１）
![rnn-lstm_3-1-3](https://user-images.githubusercontent.com/25688193/39168623-896c17c4-47cf-11e8-8e2c-b63d94bb1746.png)
...
|---|---|---|
|total|0.902|50,000|
|train data| 0.967|25,000 (50.0%)|
|test data|0.837|25,000 (50.0%)|
