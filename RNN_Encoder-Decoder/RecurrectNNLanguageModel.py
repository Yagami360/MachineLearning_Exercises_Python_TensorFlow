...
class RecurrectNNLanguageModel( NeuralNetworkBase ):
    """
    リカレントニューラルネットワークの自然言語処理モデル RNNLM [Recurrent Neural Network Language Model] を表すクラス.
    ...
    [public] public アクセス可能なインスタスンス変数には, 便宜上変数名の最後にアンダースコア _ を付ける.
        ...
        _n_in_embedding_vec : int
            埋め込み単語ベクトルのサイズ（埋め込み行列の列数）
    ...
    def __init__( 
        ...
        self._n_in_embedding_vec = n_in_embedding_vec
    ...
    def print( self, str ):
        ...
        print( "_n_in_embedding_vec : ", self._n_in_embedding_vec )
        ...
        print( "_embedding_lookup_op : \n", self._embedding_lookup_op )
        print( "_embedding_matrix_var : \n", self._embedding_matrix_var )
        if( (self._session != None) and (self._init_var_op != None) ):
            print( self._session.run( self._embedding_matrix_var ) )
