...
class NNActivation( object ):
    ...
    """
    def __init__( self, input = None, node_name = "Activation_op" ):
        self._activate_op = input
...
class Sigmoid( NNActivation ):
    ...
    """
    def __init__( self, input = None, node_name = "Activate_Sigmoid_op" ):
...
class Relu( NNActivation ):
    ...
    NNActivation クラスの子クラスとして定義
    """
    def __init__( self, input, node_name = "Activate_Relu_op" ):
...
class Softmax( NNActivation ):
    ...
    NNActivation クラスの子クラスとして定義
    """
    def __init__( self, input = None, node_name = "Activate_Softmax_op" ):
