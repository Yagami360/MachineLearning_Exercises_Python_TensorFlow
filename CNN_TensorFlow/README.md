...
- 学習率 : 0.001（減衰値） と学習率 0.005（減衰値）：モメンタム
    ...
    - 学習データは、`data_batch_1.bin`（10000サンプル）のみ
![cnn_2-3-2 _momentum](https://user-images.githubusercontent.com/25688193/33074734-9e213d40-cf0a-11e7-8fd2-19bfec525549.png)
...
|0 : airplane|0.809|1000 個|
|1 : automoblie|0.587|1000 個|
|2 : bird|0.038|1000 個|
|3 : cat|0.126|1000 個|
|4 : deer|0.005|1000 個|
|5 : dog|0.006|1000 個|
|6 : frog|0.019|1000 個|
|7 : horse|0.006|1000 個|
|8 : ship|0.047|1000 個|
|9 : tuck|0.083|1000 個|
